...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="${ctx }/manage/tradinfo/add.do">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">添加供求信息</span></div></td>
            </tr>
          <tr>
     	 ...
     	 <td width="120"><input type="text" id="name" name="name" style="width:120px" value="" /></td> 
           ...
           <tr>
	        ...
	        <tr>
	     	 	...
	     	 	<td>
	     	 		<select name="productId"  onchange="setImg(this.value)"><c:forEach var="product" items="${productList }">
						<option value="${product.id }@${product.bigImg }" >${product.name }</option>
					</c:forEach></select>
	     	 	</td> 
	     	 	<td><img id="pImg" src=""  width="100px" height="100px"/><div id="productIdTip" style="width:150px"></div></td> 
			</tr>
			<script type="text/javascript">
				function setImg(val){
          ...
          <tr>
	     	...
	     	<td width="260"><textarea rows="10" cols="30" id="detail" name="detail" style="width:260px"></textarea> </td>> 
          ...
          <tr>
    	    ...
    	    <td width="200px">
            	...
            	链接地址：<br/><input type="text" id="productImg" name="productImg" style="width:250px"/>
    	    </td> 
          ...
          <tr>
            ...
            <td><input type="text" id="validity" name="validity" style="width:120px" /></td> 
     	    <td><div id="validityTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">状态:</td>
            <td><select name="status">
				<option vlaue="上线">上线</option>
				<option vlaue="下线">下线</option>
			</select></td> 
     	    <td><div id="statusTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">地区:</td>
            <td><input type="text" id="area" name="area" style="width:120px" /></td> 

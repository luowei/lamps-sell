...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">添加广告</TD>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post"  enctype="multipart/form-data" action="${ctx }/manage/ads/add.do">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">添加广告</span></div></td>
            </tr>
          <tr>
     	 ...
     	 <td width="250">
     	 	...
     	 	链接地址：<br/><input type="text" id="img" name="img" style="width:250px"/>
     	 </td> 
          ...
          <tr>
            ...
            <td><textarea rows="10" cols="30" id="detail" name="detail" style="width:260px"></textarea></td> 

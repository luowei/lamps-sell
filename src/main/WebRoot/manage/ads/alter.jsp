...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">修改广告</TD>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="${ctx }/manage/ads/update.do">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">修改广告</span></div></td>
          </tr>
          	<input type="hidden" id="id" name="id" value="${ads.id }"/>
		  <tr>
            <td width="101" align="right">名称:</td> 
     	 	<td width="120"><input type="text" id="name" name="name" style="width:120px" value="${ads.name }" /></td> 
     	 ...
     	 <td width="250">
     	 	...
     	 	链接地址：<br/><input type="text" id="img" name="img" style="width:250px" value="${ads.img }"/>
     	 </td> 
		...
		<tr><td>&nbsp;</td></tr>
          <tr>
	     	...
	     	<td>
			<select name="status">
				<option <c:if test="${ads.status eq '上线' }">selected</c:if> vlaue="上线">上线</option>
				<option <c:if test="${ads.status eq '上线' }">selected</c:if> vlaue="下线">下线</option>
			</select>
			</td> 
          ...
          <tr>
            ...
            <td><textarea rows="10" cols="30" id="detail" name="detail" style="width:260px">${ads.detail }</textarea></td> 
     	    <td><div id="detailTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">创建时间:</td>
            <td><input type="text" id="createtime" name="createtime" style="width:120px" value="${ads.createtime }"/></td> 
     	    <td><div id="createtimeTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">排列序号:</td>
            <td><input type="text" id="orders" name="orders" style="width:120px" value="${ads.orders }"/></td> 

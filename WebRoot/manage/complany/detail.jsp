...
<HTML>
<HEAD>
<TITLE>${complany.name }详细信息</TITLE>
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">${complany.name }的详细信息</TD>
    ...
    vAlign=top>
      <div style="float: right"><a href="javascript:history.go(-1)">返回</a></div>
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="2"><div align="center"><span class="STYLE2">${complany.name }详细信息</span></div></td>
            </tr>
          <tr>
          ...
          <tr>
		      ...
		      <td>${complany.enName }</td> 
          </tr>
          <tr>
		  <td align="right" >简称:</td> 
     	 <td>${complany.shortName }</td> 
		</tr>
          <tr>
         <td align="right">企业性质:</td> 
          ...
          <tr>
    	    ...
    	    <td><img src="${complany.logo }"  width="100px" height="100px"/></td> 
          </tr>
          <tr><td>&nbsp;</td></tr>
          <tr>
            <td align="right">企业图片:</td>
     	    <td><img src="${complany.img }" width="200px" height="200px"/></td> 
          </tr>
          <tr>
          ...
          <tr>
            <td align="right">主营业务:</td>
     	    <td>${complany.primaryBusiness }</td> 
          </tr>
          <tr>
            <td align="right">企业地址:</td>
     	    <td>${complany.address }</td> 
          </tr>
          <tr>
            <td align="right">贸易地区:</td>
     	    <td>${complany.businessLocation }</td> 
          </tr>
          <tr>
            <td align="right">企业法人:</td>
     	    <td>${complany.bossName }</td> 
          </tr>
          <tr>
            <td align="right">成立日期:</td>
     	    <td>${complany.createtime }</td> 
          </tr>
          <tr>
            <td align="right">排列序号:</td>
     	    <td>${complany.orders }</td> 
          </tr>
          <tr>
            <td align="right">详细介绍:</td>
     	    <td>${complany.detail }</td> 
          </tr>

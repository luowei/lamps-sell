...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" action="${ctx }/manage/user/update.do">
      ...
      <td><input type="password" name="userPassword" id="password1" style="width:120px" value="${userInfo.userPassword }" /></td> 

...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">添加新闻</TD>
    ...
    vAlign=top>
      <form name="form1" id="form1" method="post" action="${ctx }/manage/news/add.do">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">添加新闻</span></div></td>
            </tr>
          <tr>
            <td width="101" align="right">标题:</td> 
     	 <td width="120"><input type="text" id="title" name="title" style="width:120px" value="" /></td> 
     		 <td width="342"><div id="titleTip" style="width:250px"></div></td> 
          </tr>
          <tr>
		  <td align="right">类型:</td> 
     	 <td><input type="text" id="type" name="type" style="width:120px" /></td> 

...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">修改灯具</TD>
    ...
    <div style="float: right"><a href="javascript:history.go(-1)">返回</a></div>
      <form name="form1" id="form1" method="post" enctype="multipart/form-data" action="${ctx }/manage/product/update.do">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">修改灯具</span></div></td>
          </tr>
          <tr>
          	<input type="hidden" name="id" value="${product.id }"/>"
            <td width="101" align="right">名称:</td> 
     	 <td width="120"><input type="text" id="name" name="name" style="width:120px" value="${product.name }" /></td> 
...
<%--			小类：--%>
			<select name="categoryId"><c:forEach var="category" items="${categoryList }">
				<option value="${category.id }" <c:if test="${category.id eq product.category.id }">selected</c:if>>${category.name }</option>
			</c:forEach></select>
		</td> 
	     ...
	     <td><input type="text" name="salesValume" id="salesValume" style="width:120px" value="${product.salesValume }"/></td> 
     	  <td><div id="salesValumeTip" style="width:250px"></div></td>
          </tr>
          <tr>
            <td align="right">生产地:</td> 
    	    <td><input type="text" id="produceArea" name="produceArea" style="width:120px" value="${product.produceArea }"/></td> 
          ...
          <tr>
            ...
            <td>
            	...
            	链接地址：<br/><input type="text" id="smallImg" name="smallImg"/ value="${product.smallImg }">
            </td> 
     	    <td><img src="${product.smallImg }" width="100px" height="100px"/><div id="smallFileTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">大图:</td>
            <td>
           		本地上传：<br/><input type="file" id="bigFile" name="bigFile" />
            	链接地址：<br/><input type="text" id="bigImg" name="bigImg"/ value="${product.bigImg }">
            </td> 
     	    <td><img src="${product.bigImg }" width="200px" height="200px"/><div id="bigImgTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">生产日期:</td>
            <td><input type="text" id="createtime" name="createtime" value="${product.createtime }"/></td> 
     	    <td>(格式：2012-01-01)<div id="createtimeTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">价格:</td>
            <td><input type="text" id="price" name="price" style="width:120px" value="${product.price }"/></td> 
     	    <td><div id="priceTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">数量:</td>
            <td><input type="text" id="num" name="num" style="width:120px" value="${product.num }"/></td> 
     	    <td><div id="numTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">最小数量:</td>
            <td><input type="text" id="minNum" name="minNum" style="width:120px" value="${product.minNum }"/></td> 
     	    <td><div id="numTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">排列序号:</td>
            <td><input type="text" id="orders" name="orders"  style="width:120px" value="${product.orders }"/></td> 
     	    <td><div id="sortNumTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">详细信息:</td>
            <td><textarea id="detail" name="detail" cols="30" rows="10">${product.detail }</textarea></td> 

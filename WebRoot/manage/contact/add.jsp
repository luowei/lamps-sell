...
$("#aaemail").formValidator({onshow:"请输入邮箱",onfocus:"邮箱6-100个字符,输入正确了才能离开焦点",oncorrect:"恭喜你,你输对了",defaultvalue:"@",forcevalid:true}).inputValidator({min:6,max:100,onerror:"你输入的邮箱长度非法,请确认"}).regexValidator({regexp:"^([\\w-.]+)@(([[0-9]{1,3}.[0-9]{1,3}.[0-9]{1,3}.)|(([\\w-]+.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(]?)$",onerror:"你输入的邮箱格式不正确"});
...
$("#aaqq").formValidator({empty:true,onempty:"你真的不想留下QQ号码吗？",onshow:"请输入你的QQ号码",onfocus:"请输入至少5位的QQ号码"}).InputValidator({min:5,max:12,onerror:"你输入的QQ号码长度错误"});	
...
<TABLE height="100%" cellSpacing=0 cellPadding=0 width="100%">
  <TBODY>
    <TR>
      ...
      <TD 
    style="FONT-SIZE: 18px; BACKGROUND-IMAGE: url(../images/bg_left_tc.gif); COLOR: white; FONT-FAMILY: system">添加联系人</TD>
    ...
    vAlign=top><div style="float: right"><a href="javascript:history.go(-1)">返回</a></div>
      <form name="form1" id="form1" method="post" action="${ctx }/manage/contact/add.do">
        <table width="591" height="433" border="0" align="center">
          <tr>
            <td colspan="3"><div align="center"><span class="STYLE2">添加联系人</span></div></td>
            </tr>
          <tr>
	     ...
	     <td><input type="text" name="phone" id="phone" style="width:120px" /></td> 
          ...
          <tr>
            ...
            <td><input type="text" id="http" name="http" style="width:200px" /></td> 
          ...
          <tr>
            ...
            <td><input type="text" id="zip" name="zip" style="width:120px" /></td> 
     	    <td><div id="zipTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">地址:</td>
            <td><input type="text" id="addr" name="addr" style="width:250px" /></td> 
     	    <td><div id="addrTip" style="width:250px"></div></td> 
          </tr>
          <tr>
            <td align="right">排列序号:</td>
            <td><input type="text" id="orders" name="orders" style="width:120px" /></td> 

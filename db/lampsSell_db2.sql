...
create table tradInfo(
	...
	info_type enum('求购','代理','招商','合作','招标'),	/*信息类型*/
	validity double,			/*有效期*/
...
#alter table news modify column orders int(11) default '0';
...
create table orders(
	...
	pay_satus enum('未付款','已付款') default '未付款',	/*付款状态*/
	total_price double default '0.0',			/*总价*/
...
create table ordersproduct(
	...
	product_num int(11) not null, 		/*产品数量*/
